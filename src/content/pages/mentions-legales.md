...
Numéro d'I-CAD : *à compléter*
Affixe LOOF : *à compléter*
...
L'ensemble des textes et photographies présents sur ce site sont la propriété
exclusive de la Chatterie Sciortino. Toute reproduction, totale ou partielle,
est interdite sans autorisation préalable.

## Données personnelles

Ce site est statique : il ne dépose **aucun cookie**, n'utilise aucun outil de
mesure d'audience, et ne collecte aucune donnée personnelle de navigation.

Si vous nous écrivez par email, vos coordonnées sont conservées uniquement le
temps nécessaire à l'échange et ne sont jamais transmises à des tiers.
Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et
d'effacement de vos données. Pour l'exercer, écrivez-nous via la page contact.
...
vétérinaire et d'un contrat de cession.
